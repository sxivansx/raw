    ...
    <div className={`h-screen w-screen flex flex-col font-sans select-none overflow-hidden bg-transparent ${t.text}`}>
      ...
      <div className={`flex-1 flex flex-col shadow-2xl ${t.bg} border-0 overflow-hidden relative z-10`}>
          ...
          <div className="flex flex-wrap items-center justify-between w-full px-2 py-1.5 gap-y-2">
            ...
            <div className="flex items-center gap-1 md:gap-2 relative z-10 mr-4">
              ...
              <div 
                ...
                className={`w-[28px] h-[24px] md:hidden flex items-center justify-center cursor-pointer ${!selectedNoteId && !title && !content ? 'opacity-50 pointer-events-none' : ''} ${t.button}`}
              >
            ...
            <div className="flex flex-wrap items-center gap-1 relative z-10">
              ...
              <div
                ...
                className={`relative w-[28px] h-[24px] flex items-center justify-center cursor-pointer ${t.button} font-serif font-bold text-[11px] leading-none ${!selectedNoteId && !title && !content ? 'hidden md:flex' : ''}`}
              >
                Aa
                {showFormatMenu && (
              ...
              <div
                ...
                className={`w-[28px] h-[24px] flex items-center justify-center cursor-pointer ${t.button} ${!selectedNoteId && !title && !content ? 'hidden md:flex' : ''}`}
              >
              ...
              <div
                ...
                className={`w-[28px] h-[24px] flex items-center justify-center cursor-pointer mr-2 ${t.button} ${!selectedNoteId && !title && !content ? 'hidden md:flex' : ''}`}
              >
        ...
        <div className="flex-1 flex overflow-hidden relative">
          {/* Sidebar */}
          <div className={`${t.sidebar} md:border-r ${t.border} overflow-y-auto transition-all duration-150 ${isSidebarCollapsed ? "hidden md:flex md:w-0 md:min-w-0 md:max-w-0 md:opacity-0 md:pointer-events-none" : "w-full md:w-1/3 md:min-w-[200px] md:max-w-[300px]"} ${selectedNoteId || title || content ? 'hidden md:flex' : 'flex'} flex-col`}>
            {loading ? (
          ...
          {/* Editor */}
          <div className={`${t.bg} flex-1 p-4 md:p-8 relative flex-col overflow-hidden ${!selectedNoteId && !title && !content ? 'hidden md:flex' : 'flex'}`}>
            <input 
              type="text"
